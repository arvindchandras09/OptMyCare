<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payer.aspx.cs" Inherits="OptMyCare.Payer" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin-top: -5%; margin-left: 27.5%;">
            <table>
                <tr>
                    <td>
                        <asp:Label Text="Payer" CssClass="HeadingLabelStylesheet" runat="server" ForeColor="FloralWhite"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style ="margin-top : 112px; border : 1px solid Black; width : 58.6%; background-color : lightskyblue; margin-left : 10%;">
            <table>
                <tr>
                    <td>
                        The payer knows where the patient is located, what their disease status is and <br /> what their current treatment program entails
                        (prescriptions and procedures) <br /> This information increases the accuracy of underwriting and claims analysis and <br />
                        enhances cost containment efforts
                    </td>
                    <td>
                        <asp:Image ImageUrl ="~/Images/Payer.png" runat ="server" CssClass ="payer_subimage_style" />
                    </td>
                </tr>
